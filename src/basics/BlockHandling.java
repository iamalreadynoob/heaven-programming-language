...
public class BlockHandling
{
    ...
    public static void handle(Result result, String line, AutomatedVars automatedVars, ClientDefVars clientDefVars, ClientDefKeywords clientDefKeywords, ClientDefTypes clientDefTypes, ArrayList<String> upcomingLines)
    {
        ...
        else if (pieces.get(0).equals("if") || pieces.get(0).equals("elif") || pieces.get(0).equals("else")) ConditionHandling.ifHandle(result, pieces, line);
        else if (pieces.get(0).equals("jump")) ConditionHandling.jumpHandle(result, pieces, line, upcomingLines, automatedVars, clientDefVars, clientDefKeywords, clientDefTypes);
        ...
        else if (new SyntaxDetection(line, clientDefKeywords).isKeyword()) CodeConvert.convert(result, line, pieces, clientDefKeywords, automatedVars, clientDefVars, clientDefTypes, upcomingLines);
